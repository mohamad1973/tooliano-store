...
function IconTiktok() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
...
export function HeaderIconsSocial() {
  ...
  return (
    <div className="flex shrink-0 items-center gap-0.5 sm:gap-1">
      ...
      <div
        className="flex items-center gap-0.5 ps-2 sm:gap-1 sm:ps-4"
        aria-label="وسائل التواصل"
      >
        {iconWrap(SOCIAL_URLS.facebook, "فيسبوك", <IconFacebook />)}
        {iconWrap(SOCIAL_URLS.instagram, "إنستغرام", <IconInstagram />)}
        {iconWrap(SOCIAL_URLS.tiktok, "تيك توك", <IconTiktok />)}
        {iconWrap(SOCIAL_URLS.youtube, "يوتيوب", <IconYoutube />)}
      </div>
    </div>
  );
}
